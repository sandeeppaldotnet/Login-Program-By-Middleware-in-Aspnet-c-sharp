...
namespace Login_Program_By_Middleware_in_Aspnet_c_sharp.CustomLoginMiddleware
{
    public class CustomLoginMiddlewareAspnetCore
    {
        private readonly RequestDelegate _next;
            public CustomLoginMiddlewareAspnetCore(RequestDelegate next)
        {
            _next = next;
        }
    ...
    public static class LoginMiddlewareExtensions
    {
        ...
        {
            return builder.UseMiddleware<CustomLoginMiddlewareAspnetCore>();
        }
    }
